        ...
        for (Object key : request.getParameterMap().keySet()) {
            ...
            Iterator it = s.iterator();
                ...
                while(it.hasNext()){
                    ...
                    if(mapkey.equals(key.toString())){
                    	session.setAttribute(key.toString(), entry.getValue()[0]);
                    }
                }
                
			   //session.setAttribute(key.toString(), request.getParameterMap().get("key")[0]);
			}
	        ...
	        {
	        	System.out.println("Token Is "+nvp.get("TOKEN").toString());
