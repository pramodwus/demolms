...
public Map<String, String> callShortcutExpressCheckout( HttpServletRequest request, final String returnURL, final String cancelURL)
{
	...
	if(isSet(request.getParameter("PAYMENTREQUEST_0_AMT") )){
		System.out.println("Payment Amount Is ++++++++++"+request.getParameter("PAYMENTREQUEST_0_AMT"));
	...
	if(isSet(request.getParameter("action")))
	{
	...
	session.setAttribute("licenseId", request.getParameter("L_PAYMENTREQUEST_0_NUMBER0"));
	if(isSet(returnURL))
