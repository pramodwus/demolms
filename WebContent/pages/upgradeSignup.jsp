				...
				<input type="hidden" name="action" value="${action}">
                    <div class="box-body">
                     <div class="form-group  col-sm-12  text-center">
		                    <div class="btn-group ">
		                      <button type="button" id="month"  onclick="monthly()" class="btn btn-info" style="padding: 10px 25px">Monthly</button>
		                      <button type="button" id="yearly" onclick="yearly()" class="btn btn-info" style="padding: 10px 25px">Yearly</button>
		             </div>
                     </div>
