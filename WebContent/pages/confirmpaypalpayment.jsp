...
<link rel="stylesheet" href="<spring:url value='/resources/css/confirmpayment.css'/>">	
</head>
    ...
    <div class="col-sm-7">
      ...
      <div class="licence licence--free">
        ...
        <label for="free">
          ...
          <h6><strong>$<c:out value="${licensedetails.licenseCost}"></c:out></strong> <span>Price</span></h6>
     ...
     <div class="box box-solid">
                ...
                <div class="box-body">
                  <dl class="dl-horizontal price-details">
                    ...
                    <dd><span><c:out value="${PayerID}"/></span></dd>
                    <c:forEach items="${transactionsDetails}" var ="transaction">
                    <c:if test="${transaction.amount.total!=null}">
                    <dt><span> Amount :</span></dt>
                    <dd>$<span><c:out value="${transaction.amount.total}"/></span></dd>
                    <dt><span>Tax Amount :</span></dt>
                    <dd>$<span>0.00</span></dd>
                    <dt><span>Handling Amount :</span></dt>
                    <dd>$<span>0.00</span></dd>
                    <dt><span>Discount Amount</span></dt>
                    <dd>$<span>0.00</span></dd>
                    <c:set var="totalAmount" value="${transaction.amount.total}"/>
                     </c:if>
                  </c:forEach>
                  </dl>
                  ...
                  <form action="executePayPalPayment" method="POST">
