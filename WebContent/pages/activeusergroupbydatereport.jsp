		...
		<div class="col-sm-12">
			<div class="content-wrapper">
				<section class="content-header">
					<h1><spring:message code="lbl.activeusersorgroupsbydate" text="Active Users OR Groups by Date"/></h1>
				</section>
				<!-- /.content-header -->
				<section class="content">
					...
					<td class="col-sm-12">
					   ...
					   <label><spring:message code="lbl.selectrole" text="Select Role"/>:&nbsp;</label>
							<select id="roleId" class="form-control">
							  ...
							  <option value="${list.roleId}">${list.roleName} (${list.roleId})</option>
							  </c:forEach>
							</select>
					...
					<td class="col-sm-7 lastChild" ><button type="button"
									class="btn btn-flat btn-success button-width-large searchFilterButton" style="margin-left:7%"><spring:message code="lbl.search" text="Search"/></button>
					</td></tr>
					</tbody>
					</table>
...
<script type="text/javascript">
        ...
        messages['lbl.registrationdate'] = "<spring:message code='lbl.registrationdate' text='Registration Date' javaScriptEscape='true'/>";
				...
				.dataTable(
						{
							...
							"ajax" : {
								'url' : 'getfilteractiveusersgroupdata?searchFor='
