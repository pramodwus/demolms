...
<body class="hold-transition skin-black-light sidebar-mini">
	...
	<%@ include file="leftmenu.jsp"%>  
		...
		<div class="col-sm-12 form-group">		
		    <div class="h4 capitalize form-group"><spring:message code="lbl.course" text="Learn Path"/><i class="fa fa-angle-right" style="padding-left:5px;"></i> ${course.courseName}</div>
           
           
           <div class="nav-tabs-custom" style="margin-top:30px" style="background-color:#FFF" >           
            <ul class="nav nav-tabs" >
                  <li id="li1" class="active" style="border-left:1px solid #dedede;width:50%;">
                  <a href="#basic_info"  style="text-align:center;">
                  <c:if test="${course.courseDesc!=null}">
                  ...
                  <li style="border-left:1px solid #dedede;width:50%;">
            ...
            <div class="tab-content" style="background-color: #ECF0F5 !important;">
               <div id="basic_info" class="tab-pane active">
                <form name="courseform" id="courseform" action="updatescormcourse"
				method="post" enctype="multipart/form-data">
				<input type="hidden" name="courseId" value="${course.courseId}" id="courseId">
						<div class="col-xs-12 form-group">
							<label><sup><font color="red" size="3px">*</font></sup><spring:message code="lbl.coursetitle" text="Course Title"/>:
							</label>
