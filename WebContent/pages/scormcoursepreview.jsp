...
<body class="hold-transition skin-black-light sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
                ...
                <li  style="border-left:1px solid #dedede;width:50%;"><a href="addeditscormcourse?courseId=${course.courseId}" style="text-align:center;">
                <c:if test="${course.courseTag!=''}">
                  ...
                  <li class="active" style="border-left:1px solid #dedede;width:50%;"><a href="#" data-toggle="tab" style="text-align:center;"><i class="fa fa-circle-thin" id="fa"></i><spring:message code="lbl.previewandpublish" text="Preview & Publish"/></a></li>
                </c:when>
                <c:otherwise>
                  <li  style="border-left:1px solid #dedede;width:50%;"><a style="text-align:center;"><i class="fa fa-check-circle-o color-green" id="fa"></i> <spring:message code="lbl.courseinformation" text="Course Information"/></a></li>
                  <li class="active" style="border-left:1px solid #dedede;width:50%;"><a  data-toggle="tab" style="text-align:center;"><i class="fa fa-check-circle-o color-green" id="fa"></i><spring:message code="lbl.preview" text="Preview"/></a></li>
                </c:otherwise>
                </c:choose>
                </ul>
		 ...
		 <!-- <div class="jumbotron" style="background-image: url('resources/adminlte/dist/img/photo1.png');">
                    <div id="jumbodiv">
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<c:if test="${course.publish==0}"><a href="addeditscormcourse?courseId=${course.courseId}" class="cursor-pointer"><spring:message code="lbl.edit" text="edit"/></a></c:if>
									</div>
							...
							<button type="button" class="btn btn-flat share-button btn-success"
													onclick="publishScormCoursePopup('sharewithall');"><spring:message code="lbl.sharewithall" text="Publish & share with all"/></button>
							&nbsp;&nbsp;
							<button type="button" class="btn btn-flat share-button  btn-success"
													onclick="publishScormCoursePopup('sharewithusersgroups');"><spring:message code="lbl.sharewithusersgroups" text="Publish & share with users/groups"/></button>						
							</div>
							</c:if>
							<span class="clearfix"></span>
...
<div class="modal fade" id="coursePublished" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content" style="text-align: center">
				...
				<button type="button" onclick="publisScormCourse();"
				...
				<div class="modal-content page-background-color">
					...
					<div class="modal-footer">
						...
						<button type="button" id="sharedCourseButton"
							class="btn btn-success btn-flat button-width-large" onclick="sharedScorm();" disabled><spring:message code="lbl.share" text="Share"/></button>
					</div>
				</div>
			</div>
	</div>
...
<script src="<spring:url value='/resources/js/scormcourse/scormcoursepreview.js?v=1'/>"></script>
