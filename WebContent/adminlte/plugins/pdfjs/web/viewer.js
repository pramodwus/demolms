...
var DEFAULT_PREFERENCES = {
  ...
  /**
   *  @summary this will use as selected for zooming select list.
   */
  ...
  ViewHistory.prototype = {
    _writeToStorage: function ViewHistory_writeToStorage() {
      return new Promise(function (resolve) {
        ...
        /**
         * @summary changes this one if you do not want capture previously used properties for pdf file.
         */
        localStorage.setItem('database1', databaseStr);
        resolve();
      }.bind(this));
    },
